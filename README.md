...
>Note: The intended use case for this project is individual or educational purposes. For any other type of uses, you may want to review the license terms and applicable policies.


This project provides a ready-to-use Docker Compose configuration for running n8n locally. You can use my provided configuration (set to the Europe/Warsaw timezone), modify it to match your own needs or create your own setup following the [n8n Docker installation guide](https://docs.n8n.io/hosting/installation/docker/).
...
> Use local hosted AI or wait for trusted AI to share API (i'm waiting for Lumo by Proton)
